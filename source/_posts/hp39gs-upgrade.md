...
评论区有大佬指出：可以通过 修改ADC电阻的阻值 以实现 系统自带低电量提醒 的功能，并且可以 省略升压板、减少能源损耗，同时增加内部空间。有兴趣使用此方案的话可以去评论区查看详细信息。

理论上可以做的改进还有不少，比如从Mini USB的接口引出电源线来为电池充电等。在下文提到的ROM升级中也有人通过修改电阻和显示屏，将HP 39gs升级为HP 50g。
